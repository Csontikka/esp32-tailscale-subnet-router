                                          ...
                                          const ip4_addr_t *dest)
{
     ...
     *       STA's DHCP-assigned subnet directly (e.g. 172.21.33.0/24).
...
/* Strip the trailing tailnet suffix (e.g. ".tail13ca7.ts.net") from a
 * peer hostname so the explanation reads "via nagyhaz" rather than the
